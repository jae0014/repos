...
public class MemoAddFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View v =inflater.inflate(R.layout.fragment_memo_add,container,false);
        ...
        mCancelButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                saveCondition = false;
                Dialog d = createDialog("작업을 취소하시겠습니까?" , 1);
                d.show();
    ...
    private File createImageFile() throws IOException {
        ...
        // 다이렉토리 폴더 Path 저장
        Log.e("directory",newStorageDir.getAbsolutePath());
        mMemo.setImgDIr(newStorageDir.getAbsolutePath());
